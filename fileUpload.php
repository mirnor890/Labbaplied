...
if (isset($_FILES['upload'])){
    ...
    #Denna under säger "Ta allt från en punkt i ett bildnanm och sedan allt efteråt" tex jasmin.png 
    ...
    if(empty($error)){
        ...
        move_uploaded_file($_FILES['upload']['tmp_name'], "UberGallery/gallery-images/{$_FILES['upload']['name']}");     
    }
    ...
    <head>
        <title>Security - Upload</title>
           ...
           <body>
               <div>
                   ...
                   if (isset($error)){
                       if (empty($error)){
                           ...
                           echo '<a href="UberGallery/gallery-images/' . $_FILES['upload']['name'] . '">Check file';
               ...
               <a class="btn" href="UberGallery/gallery.php">go back to Gallery</a>
           </body>
