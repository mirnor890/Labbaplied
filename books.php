...
<?php include 'header.php';?>
    ...
    <h3>This is your reserved books</h3>
<hr>
...
$query = " SELECT ISBN, Title, Author, Reserved FROM Book WHERE Reserved=1";
...
# Här är PHP-kod som connectar till databasen
    ...
    echo '<tr> <td>ISBN</td> <b><td>Title</td> <td>Author</td> <td>Reserved?</td> <td>Return</td> </b> </tr>';
    while ($stmt->fetch()) {
        if($Reserved == 0)
          $Reserved = 'NO';
